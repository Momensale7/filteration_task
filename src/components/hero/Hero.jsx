...
function Hero() {
  return (
    <section id='hero' className='grid grid-cols-[0.6378fr_0.3622fr] relative overflow-hidden'>
      <div className='bg-main grid grid-cols-[0.29fr_0.71fr] lg:pb-0  pb-10'>
        <div className='col-start-2 text-white'>
          <div className='flex items-center w-[15.5rem] mb-10 md:mb-24 lg:mb-[12.125rem]'>
      ...
      <img src={bread} className='absolute top-[17.0625rem] left-[49.51%] w-[43.625rem] h-[25.875rem]  ' alt="bread from our work" />
      <div className={`absolute z-10 bottom-0 left-0 md:block hidden bg-white w-[23.5vw] h-[12.5625rem]  `}>
        <img src={socialGroup} alt="Hero SVG" className="h-full w-full object-cover opacity-40" />
        <div className="absolute top-[2.253125rem] left-[20.5vw] flex flex-col gap-y-6 items-center justify-center">
      ...
      <h3 className={`absolute z-10 bottom-[1.25rem] pl-5 md:left-[28.1902rem] text-xs md:text-[1.125rem] text-white font-bold font-poppins`}>
